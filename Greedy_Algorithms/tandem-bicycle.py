...
if __name__ == '__main__':
    speed = tandemBicycle(redShirtSpeeds=[5, 5, 3, 9, 2], blueShirtSpeeds=[3, 6, 7, 2, 1], fastest=True)  # 32
    # speed = tandemBicycle(redShirtSpeeds=[1, 2, 1, 9, 12, 3], blueShirtSpeeds=[3, 3, 4, 6, 1, 2], fastest=False)  # 30
