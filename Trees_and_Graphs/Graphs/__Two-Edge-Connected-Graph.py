...
"""
  ...
  The number of vertices in the graph is equal to the length of edges, where each index i in
  ...
  edge would be represented by the following adjacency list edges = [[1], [0]].
